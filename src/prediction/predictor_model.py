...
class TSAnnotator:
    """Multi-layer Percentron Timeseries Annotator.

    This class provides a consistent interface that can be used with other
    TSAnnotator models.
    """
    MODEL_NAME = "Multi_layer_Percentron_Timeseries_Annotator"
    ...
    def __init__(
        ...
        **kwargs,
        ...
        """
        Construct a new Multi-layer Percentron TSAnnotator.
    ...
    def save(self, model_dir_path: str) -> None:
        """Save the Multi-layer Percentron TSAnnotator to disk.
    ...
    def load(cls, model_dir_path: str) -> "TSAnnotator":
        """Load the Multi-layer Percentron TSAnnotator from disk.

        Args:
            model_dir_path (str): Dir path to the saved model.
        Returns:
            TSAnnotator: A new instance of the loaded Multi-layer Percentron TSAnnotator.
        """
