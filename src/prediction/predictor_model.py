...
class TimeStepClassifier:
    """Multi-layer Percentron TimeStepClassifier.

    This class provides a consistent interface that can be used with other
    TimeStepClassifier models.
    """
    MODEL_NAME = "Multi_layer_Percentron_TimeStepClassifier"
    ...
    def __init__(
        ...
        **kwargs,
        ...
        """
        Construct a new Multi-layer Percentron TimeStepClassifier.
        ...
        Args:
            ...
            learning_rate (str): The learning rate schedule for weight updates.
    ...
    def build_model(self) -> MLPClassifier:
        """Build a new Multi-layer Percentron Classifier."""
        model = MLPClassifier(
    ...
    def save(self, model_dir_path: str) -> None:
        """Save the Multi-layer Percentron TimeStepClassifier to disk.
    ...
    def load(cls, model_dir_path: str) -> "TimeStepClassifier":
        """Load the Multi-layer Percentron TimeStepClassifier from disk.

        Args:
            model_dir_path (str): Dir path to the saved model.
        Returns:
            TimeStepClassifier: A new instance of the loaded Multi-layer Percentron TimeStepClassifier.
        """
